  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000037] backdrop-blur-md shadow-lg shadow-blue-950 flex flex-col items-center justify-center gap-[20px] px-[20px]'>
        ...
        <div className='border-2 border-white bg-transparent w-full rounded-full text-[18px] '>
          <input type='password' placeholder='Enter Your Password' className='w-full outline-none h-[60px] text-white placeholder:-gray-300 px-[20px] ' />
          <Eye/>
        </div>
